...
> **v1.1** : Correction de la référence à Alpine.js (technologie abandonnée, cf. `presentation_specs_v3.2.md`) dans le tableau de périmètre §1.2 — remplacée par une mention générique de la couche Présentation.
...
| Format des messages d'erreur | Affichage UI (couche Présentation) |
...
|---------|------|--------|---------------|
| 1.1 | 21 Juillet 2026 | Claude | Suppression de la référence active à Alpine.js dans le tableau de périmètre |
